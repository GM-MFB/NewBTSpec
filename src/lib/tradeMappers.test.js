...
describe('fromRow', () => {
  it('converts snake_case db row to camelCase trade object', () => {
    const row = {
      ...
      exit_date: null, status: 'open', fees: 1.5, notes: null, chart_link: null, point_value: null,
    }
    expect(fromRow(row)).toEqual({
      ...
      exitDate: '', status: 'open', fees: 1.5, notes: '', chartLink: '', pointValue: '',
    })
  })
...
describe('toRow', () => {
  it('converts camelCase trade object to snake_case db row, blanks to null', () => {
    const trade = {
      ...
      status: 'open', fees: 2, notes: '', chartLink: '', pointValue: '',
    }
    expect(toRow(trade)).toEqual({
      ...
      status: 'open', fees: 2, notes: null, chart_link: null, point_value: null,
    })
  })
  ...
  it('maps a blank pointValue to null', () => {
